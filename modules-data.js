(function () {
  ...
  window.NG_STATIC_MODULES = [{
    ...
    resources: [
      ...
      {
        id: 'rules-v2-1',
        title: 'Null Grail Core d20 v2.1 · 完整规则书',
        category: 'rules', audience: 'player',
        fileName: '《零之圣杯》Null Grail Core d20 v2.1_完整规则书.docx',
        mime: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', size: 466654,
        href: '《零之圣杯》Null Grail Core d20 v2.1_完整规则书.docx'
      },
      {
        id: 'builder-v1-1',
